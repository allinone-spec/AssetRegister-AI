      ...
      <Routes>
        {!loading && isLogin ? (
          <>
            ...
            <Route path="/chart-viewer" element={<ChartAndReportViewer />} />
            ...
            <Route path="/" element={<Layout setIsLogin={setIsLogin} />}>
              ...
              <Route path="data-console">
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<DashboardPage routeName="Dashboard" />}
                      type={
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<RegisterPage routeName="Register" />}
                      type={
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<ReportsPage routeName="Reports" />}
                      type={
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<SettingsPage routeName="Settings" />}
                      type={
              ...
              <Route path="admin-console">
                <Route
                  index
                  element={<AdminConsoleWelcomePage userName={user?.firstName} />}
                />
                <Route path="profile" element={<UserProfile />} />
                <Route
                  path="import-status"
            ...
            element={<Commom_Saved_Job heading='AR Mapping/ Saved Jobs'
              path='/admin-console/ar-mapping/tables' />}></Route> */}
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<ARTable routeName="AR Mapping" />}
                      // type={
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<ARRulesConfig routeName="AR Rules" />}
                      type={
                        permissionDetails?.["AR Rules"]?.permissionTypes.find(
                          (v) => v === "ReadOnly" || v === "WriteOnly",
                        )
                          ? permissionDetails?.["AR Rules"]?.permissionTypes[0]
                          : false
                      }
                      routeName="AR Rules"
                    />
