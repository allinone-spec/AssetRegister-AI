    ...
    try {
      ...
      if (tooltip.empty()) {
        tooltip = d3
          ...
          .style("opacity", 0)
          .style("background-color", isDark ? "#17171f" : "white")
          .style("border", isDark ? "1px solid #333" : "1px solid #ccc")
          .style("color", isDark ? "#f1f5f9" : "inherit")
      ...
      div
        ...
        .on("mouseover", function (event, d) {
          ...
          tooltip.html(
            ...
            >${
              d.label
            }</strong><br/><span style="color: ${isDark ? "#94a3b8" : "#666"};">Size: ${displaySize.toLocaleString()}</span>`,
          );
