  ...
  return (
    <PageLayout>
      <div className="flex items-center justify-center py-6 px-4 sm:px-6 lg:px-8 min-h-[calc(90vh-140px)]">
        <div className="max-w-5xl w-full bg-surface shadow-md rounded-lg border border-gray-200 min-h-[50vh] flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
              <div className="mb-5">
                ...
                <select
                  ...
                  className="mt-1 block w-full rounded-md border-gray-300 bg-input-bg shadow-sm text-sm px-2 h-[38px]"
                >
                  {API_OPTIONS.map((opt) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border-gray-300 bg-input-bg shadow-sm py-2 px-3 text-sm"
                />
