      ...
      >
        {logoPath ? (
          <img
            ...
            onError={(e) => {
              // Fallback to user initials if logo fails to load
        ...
        <div
          className={`w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold text-white bg-accent shrink-0 ${
            logoPath ? "hidden" : "flex"
          }`}
        >
