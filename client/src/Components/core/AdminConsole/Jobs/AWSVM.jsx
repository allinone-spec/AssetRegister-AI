          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <button
                type="button"
                onClick={addRoleArn}
                className="col-span-1 p-2 text-white rounded-md "
                style={{ backgroundColor }}
              >
                +
              </button>
                ...
                watch("roleArn").map((role, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="ml-2 px-2 text-white rounded-md bg-red-500"
                    >
                      ❌
                    </button>
                  </li>
              ...
              <div key={index} className="grid grid-cols-6 gap-4 mt-2">
                ...
                <button
                  ...
                  className={`col-span-1 text-white p-2 rounded-md ${
                    index === filters.length - 1 ? `bg-blue-500` : "bg-red-500"
                  }`}
                >
                  {index === filters.length - 1 ? "+" : "-"}
                </button>
