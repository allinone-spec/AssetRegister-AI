...
const AllGraph = ({ routeName }) => {
  ...
  const heading = location.state?.folderName || headingTitle;
  ...
  const handleNavigate = (data) => {
    ...
    navigate(`/data-console/dashboard/my-folder/${data?.id}`, {
      state: { data: data },
    });
    ...
    const defaultLayout = graphs.map((graph, index) => {
      ...
      if (widgetPosition) {
        return {
          ...
          w: Math.min(Math.max(widgetPosition.width || 6, 4), 12), // Width between 4 and 12
          h: Math.min(Math.max(widgetPosition.height || 5, 4), 10), // Height between 3 and 8
          minW: 4,
          maxW: 12,
          minH: 4,
          maxH: 10,
      ...
      return {
        ...
        maxW: 12,
        minH: 4,
        maxH: 10, // Maximum height for large screens
      };
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Dashboard Header */}
      <div className="sticky top-[-20px] z-10 bg-white border-b border-gray-200 mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                {/* <span className="px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded-full font-medium">
                  {filteredGraph?.length || 0} Charts
                </span> */}
                {/* {savePositionLoading && (
                  <span className="px-3 py-1 text-xs bg-yellow-100 text-yellow-800 rounded-full font-medium animate-pulse">
                    Saving...
                  </span>
                )} */}
              </div>
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`
                    ...
                    px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm`}
                  onClick={() =>
                ...
                {filteredGraph?.map((graph, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-white rounded-xl shadow-sm hover:shadow-md border border-gray-200 p-6 cursor-pointer transition-all duration-300 hover:border-blue-200"
                    >
                      <div className="flex items-center justify-between">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        className="chatCard relative bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-2xl rounded-2xl h-full w-full cursor-default transition-all duration-300 border border-gray-200/50 hover:border-blue-200 overflow-hidden"
                      >
                        {/* Card Header */}
                        <div className="absolute top-0 left-0 right-0 z-20 bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-sm p-2 border-b border-gray-100">
                          <div className="flex items-center justify-between">
                            {/* Center - Dashboard Name */}
                            {/* <div className="flex-1 text-center pl-16"> */}
                            <h3 className="ms-1 text-xl font-bold text-gray-900 truncate">
                              {graph?.dashBoardName}
                              ...
                              {permissionList.includes(routeName) &&
                                permissionDetails[routeName]?.hasWriteOnly && (
                                  <button
                                    ...
                                    className="IoMdMore p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                                  >
                                    <IoMdMore size={18} />
                                  </button>
                                )}
            ...
            <div className="flex flex-col items-center justify-center py-20">
              <div className="text-center max-w-md mx-auto">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center">
                  <MdDataExploration className="text-4xl text-blue-500" />
                </div>
                ...
                <button
                  ...
                  className={`${permissionList.includes(routeName) && !permissionDetails[routeName]?.hasWriteOnly ? "opacity-50" : "opacity-100"} px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium`}
                  onClick={() =>
                    navigate("/data-console/dashboard/new-create", {
                      state: {
                        folderName: location.state?.folderName,
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">Show Labels</h4>
                  ...
                  >
                    <div
                      className={`absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow-sm transform transition-transform ${
                        (
                          chartSettings?.[selectedChartId]?.showLabels !==
                          undefined
                            ? chartSettings[selectedChartId].showLabels
