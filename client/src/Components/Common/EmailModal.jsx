  ...
  return (
    <AnimatePresence>
      {isEmailModalOpen && (
        ...
        >
          <div className="relative bg-white shadow-lg p-6 border rounded xl:max-w-[50vw] max-w-[80vw] mx-auto mt-11 max-h-[90vh] overflow-y-auto">
            {/* Close Button */}
            <button
                ...
                <>
                  <div className="my-4">
                    ...
                    <input
                      ...
                      className={`mt-1 block w-full border rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 ${
