...
export const Commom_Saved_Job = ({
  ...
  return (
    <PageLayout>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-3 pb-8">
        {heading === "Saved Jobs" &&
          permissionList?.includes(routeName) &&
          permissionDetails[routeName]?.hasWriteOnly && (
        ...
        {heading === "Saved Jobs" && (
          <div className="group">
            ...
            {!selectedObject && (
              <div
                className="absolute left-1/2 transform -translate-x-1/2 text-white p-2 rounded-md text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                style={{
                  backgroundColor,
                  position: "absolute",
                  left: "209px",
        ...
        <div className="flex gap-3 sm:gap-6 justify-end absolute top-24 right-8">
      ...
      <DataTable
        ...
        enableCreateEmail={
          routeName === "A R Rules" ? false : heading !== "AR Mapping"
        }
